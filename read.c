...
int print_manual(FILE *file, char const *argv0) {
    ...
    return fputs(
        ...
        "\n"
        "Usage: modbus_read_register -h 192.168.0.1 -p 602 -u 1 -s 40000 -n 125 -x\n"
        "will read 125 registers starting from address 40000 with from 192.168.0.1:602 with unit id 1\n\n"
